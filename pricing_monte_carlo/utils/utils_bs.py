...
def d1(S: Number, K: Number, r: Number, sigma: Number, T: Number) -> float:
    """
...
def d2(S: Number, K: Number, r: Number, sigma: Number, T: Number) -> float:
    """
...
def bs_price(S: Number, K: Number, r: Number, sigma: Number, T: Number, is_call: bool = True) -> float:
    """
...
def bs_greeks(S: Number, K: Number, r: Number, sigma: Number, T: Number, is_call: bool = True) -> Dict:
    """
    ...
    # Second-order Greeks
    vomma = (vega * d_1 * d_2 / sigma) / 100.0
